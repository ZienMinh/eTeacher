...
function addUsers() {
  const addUsernameTextbox = document.getElementById("username");
  const addFirstnameTextbox = document.getElementById("fname");
  const addLastnameTextbox = document.getElementById("lname");
  const addPasswordTextbox = document.getElementById("password");
  const addEmailTextbox = document.getElementById("email");
  const addBirthdateTextbox = document.getElementById("dateofbirth");
