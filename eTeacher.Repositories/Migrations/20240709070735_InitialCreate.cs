    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VideoId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicVideos", x => x.VideoId);
                    table.ForeignKey(
                        name: "FK_AcademicVideos_AspNetUsers_Tutor_id",
                        column: x => x.Tutor_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScheduleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Class_id = table.Column<string>(type: "nvarchar(10)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_AspNetUsers_Student_id",
                        column: x => x.Student_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
